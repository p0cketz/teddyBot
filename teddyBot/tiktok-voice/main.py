...
def tts(session_id: str, text_speaker: str = "en_us_002", req_text: str = "TikTok Text To Speech", filename: str = 'voice.mp3', play: bool = False):
    ...
    url = f"https://api31-normal-useast2a.tiktokv.com/media/api/text/speech/invoke/?text_speaker=en_au_001&req_text=hello+there+booger+butt&speaker_map_type=0&aid=1233"
